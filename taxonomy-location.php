...
<div class="br-main-wrapper blog-wrapper">
	...
	<div class="br-main-wrapper blog-wrapper tour-wrapper">
					...
					<?php if (!empty($terms)) : ?>
						<?php foreach ($terms as $term) : ?>
							...
							<li class="br-tour-list">
								...
								<div class="br_foot">
									<h3 class="br-title">
										<a href="<?php echo esc_url(get_term_link($term)); ?>" rel="bookmark" title="<?php echo esc_attr($term->name); ?>"><?php echo esc_html($term->name); ?></a>
									</h3>
									<div class="br-description">+ <?php echo esc_html($product_count.' Yachts available here'); ?> </div>
									<a href="<?php echo esc_url(home_url('shop/?' . $data_params)); ?>" class="br-btn" tabindex="-1"><?php echo esc_html('View Detail', 'boatrental'); ?></a>
								</div>
