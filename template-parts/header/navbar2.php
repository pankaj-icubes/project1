...
<div class="br-header-inner header2">
...
<?php } ?>
          ...
          <nav class="desktop-nav hamburger-menu">
            <div id="mySidenavDesk" class="sidenav">

            <div class="sidenav-wrap">
             <div class="sidenav-left">
             <div class="br-sidelogo">
             <a class="br-logo" href="<?php echo esc_url(boatrental_url); ?>"><img src="<?php echo esc_url(Boatrental_Main::get_meta('sitelogo')); ?>" alt="Logo" class="img-fluid"></a>
            </div>
              <a href="javascript:void(0)" class="closebtn" onclick="closeNavDesk()">&times;</a>
            ...
            <span class="openbtn" onclick="openMobileNavDesk()"><i class="fas fa-bars" aria-hidden="true"></i></span>
          </nav>
...
<script>
      function openMobileNavDesk() {
        document.getElementById("mySidenavDesk").style.width = "40%";
      }

      function closeNavDesk() {
        document.getElementById("mySidenavDesk").style.width = "0";
      }
    </script>
